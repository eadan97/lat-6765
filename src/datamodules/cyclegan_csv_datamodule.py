...
from src.datamodules.datasets.csv_image_dataset import CsvImageDataset


class CycleGanCsvDatamodule(LightningDataModule):
    """
    ...
    def __init__(
        ...
        self.transforms = transforms.Compose(
            [transforms.ToPILImage(), transforms.Resize(image_size + image_margin), transforms.RandomCrop(image_size),
    ...
    def setup(self, stage: Optional[str] = None):
        ...
        dataset_train = CsvImageDataset(self.csv_path, self.data_dir, transform=self.transforms, use_gpu=self.use_gpu,
